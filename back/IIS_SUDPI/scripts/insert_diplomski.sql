...
-- ============================================
-- 3. JEDINICA_MERE (šifarnik - i količinske jedinice i valute)
-- ============================================
...
-- ============================================
-- 6. PROIZVOD (dodato pdv_stopa_pr i jedinica_mere_sifra_jm)
-- ============================================

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (1, 'Pšenično brašno T-500', 'Visokokvalitetno pšenično brašno tip 500 za industriju', 1, 10, 4);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (2, 'Integralno brašno', 'Brašno od celih zrna pšenice, bogato vlaknima', 1, 10, 4);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (3, 'UHT mleko 3.2%', 'Trajno mleko sa 3.2% mlečne masti', 2, 10, 7);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (4, 'Pavlaka 20%', 'Pavlaka za kuvanje sa 20% mlečne masti', 2, 20, 7);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (5, 'Jabuke Idared I klasa', 'Sveže jabuke sorte Idared, prva klasa kvaliteta', 3, 10, 4);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (6, 'Natrijum benzoat E211', 'Konzervans za produženje roka trajanja proizvoda', 4, 20, 4);

INSERT INTO proizvod (sifra_pr, naziv_pr, opis_pr, kategorija_proizvoda_sifra_kp, pdv_stopa_pr, jedinica_mere_sifra_jm)
VALUES (7, 'Kristal šećer', 'Rafinirani beli kristal šećer', 5, 20, 4);
...
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (1, 85.50, TO_DATE('2026-01-10', 'YYYY-MM-DD'), NULL, 1, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (2, 95.00, TO_DATE('2025-08-01', 'YYYY-MM-DD'), NULL, 2, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (3, 125.00, TO_DATE('2026-02-15', 'YYYY-MM-DD'), NULL, 3, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (4, 180.00, TO_DATE('2026-01-20', 'YYYY-MM-DD'), NULL, 4, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (5, 65.00, TO_DATE('2025-10-01', 'YYYY-MM-DD'), NULL, 5, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (6, 450.00, TO_DATE('2025-05-20', 'YYYY-MM-DD'), NULL, 6, 1);
INSERT INTO cenovnik (sifra_c, cena_c, datum_od_c, datum_do_c, proizvod_dobavljaca_id, jedinica_mere_sifra_jm) VALUES (7, 95.00, TO_DATE('2026-01-15', 'YYYY-MM-DD'), NULL, 7, 1);
...
-- ============================================
-- 10. PENAL (tip_penala_p dodat)
-- ============================================

-- AGRO INVEST - 4 PENALA na 3 od 4 ugovora (75% stopa kršenja)
INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (1, 'Nedostajuća dokumentacija - sertifikat kvaliteta', 8500.00, TO_DATE('2025-11-15', 'YYYY-MM-DD'), 'KVALITET', 1);

INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (2, 'Isporučena količina manja od ugovorene (850kg umesto 1000kg)', 12000.00, TO_DATE('2026-03-05', 'YYYY-MM-DD'), 'OSTALO', 1);

INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (3, 'Kašnjenje u isporuci od 3 dana', 9000.00, TO_DATE('2026-02-20', 'YYYY-MM-DD'), 'KASNJENJE_ISPORUKE', 6);

INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (4, 'Kvalitet brašna ispod standarda - vraćena pošiljka', 15500.00, TO_DATE('2026-01-25', 'YYYY-MM-DD'), 'KVALITET', 12);

-- VOĆE SRBIJA - 1 PENAL na 1 od 3 ugovora (33% stopa kršenja)
INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (5, 'Kašnjenje u isporuci od 2 dana', 7500.00, TO_DATE('2026-03-10', 'YYYY-MM-DD'), 'KASNJENJE_ISPORUKE', 3);

-- ŠEĆERANA CRVENKA - 1 PENAL na 1 od 5 ugovora (20% stopa kršenja)
INSERT INTO penal (sifra_p, razlog_p, iznos_p, datum_p, tip_penala_p, ugovor_sifra_u)
VALUES (6, 'Ekstremno kašnjenje u isporuci od 14 dana + nekompletna dokumentacija', 25000.00, TO_DATE('2025-12-20', 'YYYY-MM-DD'), 'KASNJENJE_ISPORUKE', 5);

-- ============================================
-- 11. FAKTURA (razlog_cekanja_f uklonjen - vidi PROMENA_STATUSA; dodata valuta)
-- ============================================

INSERT INTO faktura (sifra_f, iznos_f, datum_prijema_f, rok_placanja_f, status_f, ugovor_sifra_u, jedinica_mere_sifra_jm)
...
-- ============================================
-- 12. STAVKA FAKTURE (proizvod_sifra_pr -> proizvod_dobavljaca_id)
-- ============================================

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (1, 'Pšenično brašno T-500', 1000, 85.50, 'Mesečna isporuka', 1, 1);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (2, 'UHT mleko 3.2%', 500, 125.00, 'Nedeljna isporuka 1', 2, 3);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (3, 'Jabuke Idared I klasa', 500, 65.00, 'Sezonska isporuka', 3, 5);
...
INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (6, 'UHT mleko 3.2%', 1000, 125.00, 'Nedeljne isporuke 2-5', 6, 3);
...
INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (9, 'Jabuke Idared I klasa', 600, 65.00, 'Isporuka - prva serija', 8, 5);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (10, 'Jabuke Idared I klasa', 700, 65.00, 'Isporuka - druga serija', 9, 5);
...
INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (13, 'Kristal šećer', 2000, 95.00, 'Majska isporuka - povećana količina', 12, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (14, 'Kristal šećer', 1250, 95.00, 'Junska isporuka šećera', 13, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (15, 'Pšenično brašno T-500', 1100, 85.50, 'Industrijska isporuka', 14, 1);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (16, 'Pšenično brašno T-500', 1250, 85.50, 'Industrijska isporuka', 15, 1);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (17, 'Integralno brašno', 900, 95.00, 'Isporuka integralnog brašna', 16, 2);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (18, 'Pšenično brašno T-500', 1200, 85.50, 'Sezonska isporuka', 17, 1);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (19, 'Jabuke Idared I klasa', 800, 65.00, 'Zimska isporuka', 18, 5);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (20, 'Kristal šećer', 800, 95.00, 'Fin šećer u prahu', 19, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (21, 'Kristal šećer', 3000, 95.00, 'Industrijska količina - kvartalno', 20, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (22, 'Kristal šećer', 500, 95.00, 'Rezervna hitna isporuka', 21, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (25, 'Pšenično brašno T-500', 1100, 85.50, 'Prva serija', 23, 1);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (26, 'UHT mleko 3.2%', 600, 125.00, 'Nedeljne isporuke mleka', 24, 3);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (27, 'Pavlaka 20%', 25, 180.00, 'Dodatak uz mleko', 24, 4);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (28, 'Jabuke Idared I klasa', 800, 65.00, 'Jesenja isporuka jabuka', 25, 5);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (29, 'Kristal šećer', 1750, 95.00, 'Povećana količina', 26, 7);

INSERT INTO stavka_fakture (sifra_sf, naziv_sf, kolicina_sf, cena_po_jed_sf, opis_sf, faktura_sifra_f, proizvod_dobavljaca_id)
VALUES (30, 'Integralno brašno', 800, 95.00, 'Isporuka integralnog brašna', 27, 2);
...
-- ============================================
-- 15. OCENA_DOBAVLJACA (po kriterijumu i periodu - dopunjuje Dobavljac.ocena_db)
-- ============================================

INSERT INTO ocena_dobavljaca (sifra_od, kriterijum_od, vrednost_od, period_od_od, period_do_od, datum_ocenj_od, dobavljac_sifra_db)
VALUES (1, 'BROJ_PENALA', 6.00, TO_DATE('2025-09-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), 1);

INSERT INTO ocena_dobavljaca (sifra_od, kriterijum_od, vrednost_od, period_od_od, period_do_od, datum_ocenj_od, dobavljac_sifra_db)
VALUES (2, 'POSTOVANJE_ROKOVA', 6.50, TO_DATE('2025-09-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), 1);

INSERT INTO ocena_dobavljaca (sifra_od, kriterijum_od, vrednost_od, period_od_od, period_do_od, datum_ocenj_od, dobavljac_sifra_db)
VALUES (3, 'TACNOST_FAKTURISANJA', 9.20, TO_DATE('2025-09-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), 2);

INSERT INTO ocena_dobavljaca (sifra_od, kriterijum_od, vrednost_od, period_od_od, period_do_od, datum_ocenj_od, dobavljac_sifra_db)
VALUES (4, 'ODNOS_CENA', 8.00, TO_DATE('2025-09-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), 3);

INSERT INTO ocena_dobavljaca (sifra_od, kriterijum_od, vrednost_od, period_od_od, period_do_od, datum_ocenj_od, dobavljac_sifra_db)
VALUES (5, 'BROJ_PENALA', 9.00, TO_DATE('2025-09-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), 5);

-- ============================================
-- 16. KONTROLNA_TABLA + KREIRANJE (bivši DASHBOARD + kreira)
-- ============================================
...
-- ============================================
-- 17. METRIKA (definicije - iste koje views_mk.py get_or_create-uje uživo)
-- ============================================
...
-- ============================================
-- 18. MERENJE (par ilustrativnih istorijskih merenja za tablu FA #1)
-- ============================================

INSERT INTO merenje (id, kontrolna_tabla_sifra_kt, metrika_sifra_m, vrednost_me, vreme_merenja_me, period_od_me, period_do_me)
VALUES (1, 1, 1, 373250.00, TO_TIMESTAMP('2026-03-01 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);

INSERT INTO merenje (id, kontrolna_tabla_sifra_kt, metrika_sifra_m, vrednost_me, vreme_merenja_me, period_od_me, period_do_me)
VALUES (2, 1, 2, 185750.00, TO_TIMESTAMP('2026-03-01 08:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);

INSERT INTO merenje (id, kontrolna_tabla_sifra_kt, metrika_sifra_m, vrednost_me, vreme_merenja_me, period_od_me, period_do_me)
VALUES (3, 1, 6, 373250.00, TO_TIMESTAMP('2026-03-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2026-03-01', 'YYYY-MM-DD'), TO_DATE('2026-03-31', 'YYYY-MM-DD'));

-- ============================================
-- 19. IZVEŠTAJ (visi na KREIRANJE; tip_i suženo na FINANSIJSKI/DOBAVLJACI/UGOVORI/PLACANJA)
-- ============================================
...
-- ============================================
-- 20. PREDMET_IZVESTAJA (zamenjuje bivše koristi/poseduje - tačno jedan FK po redu)
-- ============================================
...
-- ============================================
-- 21. NOTIFIKACIJA + SE_SALJE (nepromenjeno - Notifikacija nije deo ovog EER-a)
-- ============================================
